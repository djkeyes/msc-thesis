...
#SBATCH --output=./log/fire.out
#SBATCH --error=./log/fire.err
#
#
...
ulimit -a
dt="`date '+%s'`"
#srun /home/dkeyes/local/bin/caffe train -gpu all -solver /home/dkeyes/git/msc-thesis/python/DescriptorLearning/fire_solver.prototxt -weights /import/euryale/projects/dkeyes/experiments/denseCorrespondence-aligned-sparse/fire_iter_4000.caffemodel
srun /home/dkeyes/local/bin/caffe train -gpu all -solver /home/dkeyes/git/msc-thesis/python/DescriptorLearning/fire_solver.prototxt -weights /import/euryale/projects/dkeyes/experiments/denseCorrespondence/fire_iter_1500_orig.caffemodel
stat="$?"
dt=$(( `date '+%s'` - ${dt} ))
